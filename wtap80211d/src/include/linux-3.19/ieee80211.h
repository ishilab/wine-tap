/*
 * IEEE 802.11 defines for the use of applications
 *
 ...
 *
 * Copyrigtt (c) 2016, 2017 Arata Kato <aoakartist@gmail.com>
 *
 * This program is free software; you can redistribute it and/or modify
 * it under the terms of the GNU General Public License version 2 as
 * published by the Free Software Foundation.
 *
 * This program was forked from Linux/include/net/ieee80211.h for the use of
 * user applications.
 */
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_a4(u16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_morefrags(u16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_retry(u16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_pm(u16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_moredata(u16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_has_order(u16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_ctl(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE)) ==
         (IEEE80211_FTYPE_CTL);
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_data_present(u16 fc)
{
  /*
   * mask with 0x40 and test that that bit is clear to only return true
   * for the data-containing substypes.
   */
  return (fc & (IEEE80211_FCTL_FTYPE | 0x40)) ==
         (IEEE80211_FTYPE_DATA);
}
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_assoc_req(u16 fc)
{
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_assoc_resp(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_reassoc_req(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_reassoc_resp(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_probe_req(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_probe_resp(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_action(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_back_req(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_back(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_pspoll(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_rts(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_cts(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_ack(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_cfend(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_cfendack(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_nullfunc(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 * @fc: frame control bytes in little-endian byteorder
 */
static inline int ieee80211_is_qos_nullfunc(u16 fc)
{
  return (fc & (IEEE80211_FCTL_FTYPE | IEEE80211_FCTL_STYPE)) ==
 ...
 */
static inline bool ieee80211_is_bufferable_mmpdu(u16 fc)
{
 ...
 */
static inline int ieee80211_is_first_frag(u16 seq_ctrl)
{
  return (seq_ctrl & (IEEE80211_SCTL_FRAG)) == 0;
}
 ...
 * @frame: the pointer to the head of frame data
 * @frame_len: length of the frame
 */
static inline bool ieee80211_is_robust_mgmt_frame(void *frame,
                                                  unsigned int frame_len)
{
  if (frame_len < 25)
    return false;
  return _ieee80211_is_robust_mgmt_frame(frame);
}
 ...
 */
static inline bool ieee80211_action_contains_tpc(void* frame,
                                                 unsigned int frame_len)
{
  ...
  if (frame_len < IEEE80211_MIN_ACTION_SIZE +
